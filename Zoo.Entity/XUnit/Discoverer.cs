...
{
    internal class Discoverer : XunitTestFrameworkDiscoverer
    {
        ...
        {
            var factDiscoverer = new ExtendedFactDiscoverer(new FactDiscoverer(this.DiagnosticMessageSink))
            {
                DiagnosticMessageSink = this.DiagnosticMessageSink
            };
            var theoryDiscoverer = new ExtendedFactDiscoverer(new TheoryDiscoverer(this.DiagnosticMessageSink))
            {
                DiagnosticMessageSink = this.DiagnosticMessageSink
            };
