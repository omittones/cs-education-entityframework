    ...
    public class ControllerActivator : IHttpControllerActivator
    {
            ...
            Type controllerType)
        {
            ...
            if (_fastCache == null)
            {
                ...
                {
                    Tuple<HttpControllerDescriptor, Func<IHttpController>> cacheItem = Tuple.Create(
                        controllerDescriptor, activator);
        ...
        private static IHttpController GetInstanceOrActivator(HttpRequestMessage request, Type controllerType,
            out Func<IHttpController> activator)
        {
            ...
            activator = () => (IHttpController) Activator.CreateInstance(controllerType);
